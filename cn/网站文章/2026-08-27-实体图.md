...
```svg
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 880 460" role="img" aria-label="JSON-LD 实体图：文章与网站名片指向人物名片，人物与机构名片互相指向形成闭环" class="entity-diagram">
  <defs>
    <marker id="arr" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
      <path d="M0,0 L10,5 L0,10 z" fill="#6e6e73"/>
    </marker>
    <style>
      .lbl{font:14px -apple-system,"PingFang SC","Helvetica Neue",sans-serif;fill:#1d1d1f}
      .sub{font:12px -apple-system,"PingFang SC","Helvetica Neue",sans-serif;fill:#6e6e73}
      .tag{font:11px -apple-system,"PingFang SC","Helvetica Neue",sans-serif;fill:#86868b}
      .edge{font:12px -apple-system,"PingFang SC","Helvetica Neue",sans-serif;fill:#424245}
      .nl{stroke:#86868b;stroke-width:1.2;fill:none}
    </style>
  </defs>

  <!-- Article 节点（方角，蓝） -->
  <g>
    <rect x="40" y="70" width="150" height="64" rx="2" fill="#f0f5ff" stroke="#3b6fd4" stroke-width="1.2"/>
    <text x="115" y="95" text-anchor="middle" class="tag">Article</text>
    <text x="115" y="118" text-anchor="middle" class="lbl">文章名片</text>
  </g>

  <!-- WebSite 节点（方角，蓝） -->
  <g>
    <rect x="40" y="200" width="150" height="64" rx="2" fill="#f0f5ff" stroke="#3b6fd4" stroke-width="1.2"/>
    <text x="115" y="225" text-anchor="middle" class="tag">WebSite</text>
    <text x="115" y="248" text-anchor="middle" class="lbl">网站名片</text>
  </g>

  <!-- Person 节点（圆角，绿） -->
  <g>
    <rect x="360" y="120" width="180" height="120" rx="14" fill="#edf7ee" stroke="#2e8b4e" stroke-width="1.2"/>
    <text x="450" y="145" text-anchor="middle" class="tag">Person</text>
    <text x="450" y="167" text-anchor="middle" class="lbl">人物名片 · 纪优</text>
    <line x1="380" y1="178" x2="520" y2="178" stroke="#cfe3d2" stroke-width="1"/>
    <text x="375" y="197" class="sub">@id: …/#person</text>
    <text x="375" y="214" class="sub">sameAs: 知乎 · GitHub</text>
    <text x="375" y="231" class="sub">knowsAbout: 4 领域</text>
  </g>

  <!-- Organization 节点（虚线边，紫） -->
  <g>
    <rect x="680" y="150" width="160" height="100" rx="2" fill="#f7f0fb" stroke="#7a3fb4" stroke-width="1.2" stroke-dasharray="5,3"/>
    <text x="760" y="175" text-anchor="middle" class="tag">Organization</text>
    <text x="760" y="197" text-anchor="middle" class="lbl">机构名片 · 纪优</text>
    <line x1="695" y1="208" x2="825" y2="208" stroke="#e4d4f0" stroke-width="1"/>
    <text x="695" y="227" class="sub">@id: …/#organization</text>
    <text x="695" y="244" class="sub">founder → #person</text>
  </g>

  <!-- 边 -->
  <!-- A → P : author -->
  <path d="M190,102 C270,102 290,140 360,150" class="nl" marker-end="url(#arr)"/>
  <text x="270" y="118" text-anchor="middle" class="edge">author 作者</text>

  <!-- W → P : author -->
  <path d="M190,232 C270,232 290,210 360,205" class="nl" marker-end="url(#arr)"/>
  <text x="270" y="223" text-anchor="middle" class="edge">author 作者</text>

  <!-- W → O : publisher -->
  <path d="M190,250 C400,310 580,300 680,230" class="nl" marker-end="url(#arr)"/>
  <text x="440" y="312" text-anchor="middle" class="edge">publisher 发布者</text>

  <!-- P → O : worksFor -->
  <path d="M540,180 L680,190" class="nl" marker-end="url(#arr)"/>
  <text x="610" y="178" text-anchor="middle" class="edge">worksFor 就职于</text>

  <!-- O → P : founder (回流，弧线绕上方) -->
  <path d="M720,150 C640,90 580,95 540,140" class="nl" marker-end="url(#arr)"/>
  <text x="630" y="95" text-anchor="middle" class="edge">founder 创始人</text>

  <!-- 图注 -->
  <text x="440" y="430" text-anchor="middle" class="tag">实体图：箭头 = "指向"，即名片里用 @id 引用而非重写</text>
</svg>
```
