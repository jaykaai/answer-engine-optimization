...
```svg
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 520" role="img" aria-label="JSON-LD 实体图：文章与网站名片指向人物名片，人物与机构名片互相指向形成闭环" class="entity-diagram">
  <defs>
    ...
    <style>
      ...
      .edge{font:12px -apple-system,"SF Pro Text","PingFang SC","Helvetica Neue",sans-serif;fill:#6e6e73}
      .nl{stroke:#a1a1a6;stroke-width:1.1;fill:none;stroke-linecap:round}
      .card{fill:#ffffff;stroke:#d2d2d7;stroke-width:1}
      .cardAlt{fill:#fbfbfd;stroke:#d2d2d7;stroke-width:1}
  ...
  <!-- 分组标题 -->
  <text x="120" y="80" text-anchor="middle" class="tag">内容实体</text>
  <text x="465" y="80" text-anchor="middle" class="tag">人物实体</text>
  <text x="780" y="80" text-anchor="middle" class="tag">机构实体</text>

  <!-- Article 卡片 -->
  <g>
    <rect x="50" y="100" width="140" height="78" rx="16" class="card"/>
    <circle cx="68" cy="122" r="3.5" class="dotBlue"/>
    <text x="80" y="126" class="tag">ARTICLE</text>
    <text x="120" y="152" text-anchor="middle" class="tt">文章名片</text>
  </g>

  <!-- WebSite 卡片 -->
  <g>
    <rect x="50" y="250" width="140" height="78" rx="16" class="card"/>
    <circle cx="68" cy="272" r="3.5" class="dotBlue"/>
    <text x="80" y="276" class="tag">WEBSITE</text>
    <text x="120" y="302" text-anchor="middle" class="tt">网站名片</text>
  </g>

  <!-- Person 卡片（核心，略大） -->
  <g>
    <rect x="360" y="160" width="210" height="160" rx="18" class="cardAlt"/>
    <circle cx="378" cy="184" r="3.5" class="dotGreen"/>
    <text x="390" y="188" class="tag">PERSON</text>
    <text x="465" y="214" text-anchor="middle" class="tt">人物名片 · 纪优</text>
    <line x1="380" y1="230" x2="550" y2="230" class="divider"/>
    <text x="380" y="252" class="sub">@id  …/#person</text>
    <text x="380" y="272" class="sub">sameAs  知乎 · GitHub</text>
    <text x="380" y="292" class="sub">knowsAbout  4 个领域</text>
  </g>

  <!-- Organization 卡片 -->
  <g>
    <rect x="680" y="190" width="170" height="120" rx="16" class="card"/>
    <circle cx="698" cy="214" r="3.5" class="dotPurple"/>
    <text x="710" y="218" class="tag">ORGANIZATION</text>
    <text x="765" y="244" text-anchor="middle" class="tt">机构名片 · 纪优</text>
    <line x1="698" y1="260" x2="832" y2="260" class="divider"/>
    <text x="698" y="282" class="sub">@id  …/#organization</text>
    <text x="698" y="300" class="sub">founder → #person</text>
  </g>

  <!-- 边：A → P author -->
  <path d="M190,139 C270,139 290,175 360,190" class="nl" marker-end="url(#arr)"/>
  <text x="275" y="132" text-anchor="middle" class="edge">author</text>

  <!-- 边：W → P author -->
  <path d="M190,289 C270,289 290,270 360,255" class="nl" marker-end="url(#arr)"/>
  <text x="275" y="282" text-anchor="middle" class="edge">author</text>

  <!-- 边：W → O publisher（下方弧线） -->
  <path d="M190,312 C400,370 560,360 680,300" class="nl" marker-end="url(#arr)"/>
  <text x="430" y="375" text-anchor="middle" class="edge">publisher</text>

  <!-- 边：P → O worksFor -->
  <path d="M570,234 L680,240" class="nl" marker-end="url(#arr)"/>
  <text x="625" y="230" text-anchor="middle" class="edge">worksFor</text>

  <!-- 边：O → P founder（上方回流弧线） -->
  <path d="M730,190 C660,130 580,130 570,175" class="nl" marker-end="url(#arr)"/>
  <text x="650" y="128" text-anchor="middle" class="edge">founder</text>

  <!-- 图注 -->
  <text x="450" y="475" text-anchor="middle" class="tag">箭头 = "指向"：名片里用 @id 引用对方，不重写一份</text>
</svg>
```
